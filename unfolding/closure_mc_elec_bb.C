...
TFile *f1 = TFile::Open("unfolded_mc_elec_bb.root");
f1->GetObject("dy_gen_el", hmu_data);

TFile *f2 = TFile::Open("data_elec_2018_bb_script_0b.root");
f2->GetObject("bkg_el", hmu_bkg);

TFile *f3 = TFile::Open("unfolded_mc_elec_bb.root");
f3->GetObject("o", hdy);
