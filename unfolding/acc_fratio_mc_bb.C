...
//      TLatex *   tex = new TLatex(105,400,"CMS");
   ...
   tex1->Draw();
        ...
        legend->AddEntry(hdiv1,"unscaled flavor ratio (Data - bkg)","lep");
        legend->AddEntry(hdiv3,"flavor ratio template (DY MC)","lep");


        legend->Draw();

c1->SaveAs("plots/acc_corr_fratio_bb_mc.png");
c1->SaveAs("plots/acc_corr_fratio_bb_mc.pdf");
c1->SaveAs("plots/acc_corr_fratio_bb_mc.root");
}
