...
TH1 *hmu_unfolded, *hele_unfolded, *hmu_gen, *hele_gen, *hmu_reco, *hele_reco;
TH1 *hmu_data, *hmu_bkg, *hdy;
TFile *f1 = TFile::Open("unfolded_mc_muon_bb.root");
f1->GetObject("dy_gen_mu", hmu_data);

TFile *f2 = TFile::Open("data_muon_2018_bb_script_0b.root");
f2->GetObject("bkg_mu", hmu_bkg);

TFile *f3 = TFile::Open("unfolded_mc_muon_bb.root");
f3->GetObject("o", hdy);
...
//   pad1->SetGridx();
 ...
 //  pad1->SetTopMargin(0.00101554);
   ...
   pad1->SetFrameBorderMode(0);
        ...
        TH1F *hdiv2 = (TH1F*)hmu_bkg->Clone("hdiv2");  //bkg
...
hdiv1->SetMarkerColor(kBlack);
   ...
   hdiv1->GetXaxis()->SetTitle("m_{#mu#mu} [GeV]");
...
c1->SaveAs("plots/closure_bb_mu.png");
c1->SaveAs("plots/closure_bb_mu.pdf");
c1->SaveAs("plots/closure_bb_mu.root");
}
